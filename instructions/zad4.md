## Zadanie 4: Analiza wiersza

W poniższym kodzie zamieszczono tekst wiersza. Naszym celem jest sprawdzenie, na jaką literę najczęściej zaczynają się słowa w badanym tekście. Program powinien wypisać wszystkie słowa, które zaczynają się na tę literę.

Dla ułatwienia mamy dostępną funkcję, która przetwarza tekst na pojedyncze słowa (bez znaków interpunkcyjnych), a także proponowaną strukturę danych, na której należy oprzeć rozwiązanie.
